...
import com.pecpaker.androidgame.databinding.FragmentGameBinding
...
class GameFragment : Fragment() {
    ...
    private fun setQuestion() {
        ...
        // and shuffle them
        answers.shuffle()
        (activity as AppCompatActivity).supportActionBar?.title = getString(R.string.title_android_game_question, questionIndex + 1, numQuestions)
    }
